...
import com.jetflow.util.DateEditor;
...
public class BaseController {
	...
	protected static final String SIMPLE_VIEW_PATH = "siemens";
	...
	public Map<String, Object> setJson(boolean success, String message,
			Object entity) {
