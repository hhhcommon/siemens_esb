...
import com.jetflow.service.SysUserService;
import com.jetflow.util.SingletonLoginUtils;
import com.jetflow.util.WebUtils;

@Controller
@RequestMapping("/")
public class LoginController extends BaseController{
	private static final Logger logger = LoggerFactory.getLogger(LoginController.class);
	private static String loginPage = getViewPath("/admin/main/login");//登录页面
	private static String loginSuccess="redirect:/admin/main";//主界面
